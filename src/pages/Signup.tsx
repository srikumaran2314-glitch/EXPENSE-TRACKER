    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      ...
      >
        <div className="p-8 text-center bg-stone-800 text-white border-b border-white/5">
          ...
          <p className="text-white/60 mt-1">Start tracking expenses with your partner</p>
        </div>
        ...
        <div className="p-8 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-bold text-white/40 uppercase mb-2">Mobile Number</label>
                <div className="relative">
            ...
            <div>
              <label className="block text-xs font-bold text-white/40 uppercase mb-2">Gender (for Theme)</label>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-white text-black py-4 rounded-2xl font-bold text-lg hover:bg-stone-200 transition-all shadow-lg shadow-white/10 flex items-center justify-center gap-2 mt-4"
            >
